...
type DSSWorkflowStatusResponse struct {
	...
	CurrentStep    int        `json:"current_step"`    // 0-4 (0=not started, 1-4=steps)
	...
	Step3Applied bool `json:"step3_applied"` // Goal-Debt Trade-off
	Step4Applied bool `json:"step4_applied"` // Budget Allocation
}
